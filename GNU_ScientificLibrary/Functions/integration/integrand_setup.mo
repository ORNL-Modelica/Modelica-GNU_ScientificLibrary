...
//   copying archive file to default directory...
  ar_file := Modelica.Utilities.Files.loadResource("modelica://GNU_ScientificLibrary/Resources/Library/linux64/libgsl_integration_MI.so");
  Modelica.Utilities.Files.copy("libgsl_integration_MI.so",ar_file,replace=true);
  ar_file := Modelica.Utilities.Files.loadResource("modelica://GNU_ScientificLibrary/Resources/Library/win64/gsl_integration_MI.dll");
  Modelica.Utilities.Files.copy("libgsl_integration_MI.so",ar_file,replace=true);
  annotation(
