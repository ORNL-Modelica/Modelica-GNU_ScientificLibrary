...
equation
// kludge to get flattened/compiled model to link with libgsl
  Fmhalf = GNU_ScientificLibrary.Functions.specfunc.fermidirac_Fmhalf(y_ramp.y);
//
