...
equation
  ...
  Documentation(info = "<html><head></head><body>Evaluation of double Fermi-Dirac integrals. e.g., ...&nbsp;<div><div><br></div><div><span class=\"Apple-tab-span\" style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px; white-space: pre;\">	</span>∫<sub>-∞</sub><sup>y</sup><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">&nbsp;F</span><sub style=\"font-family: 'DejaVu Sans Mono';\">-1/2</sub><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">(x) F</span><sub style=\"font-family: 'DejaVu Sans Mono';\">-1/2</sub><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">(x) dx&nbsp;</span></div></div><div><font face=\"DejaVu Sans Mono\"><br></font><div><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">or more generally ...&nbsp;</span></div><div><br></div><div><span style=\"font-size: 12px;\"><span class=\"Apple-tab-span\" style=\"white-space: pre;\">	</span>[Γ(m)]<sup>-1</sup> ∫<sub>-∞</sub><sup>y</sup><font face=\"DejaVu Sans Mono\">&nbsp;(y-x)</font></span><sup style=\"font-family: 'DejaVu Sans Mono';\">m-1</sup><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">&nbsp;F</span><span style=\"font-family: 'DejaVu Sans Mono';\"><font size=\"2\"><sub>j</sub></font></span><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">(x) F</span><sub style=\"font-family: 'DejaVu Sans Mono';\">k</sub><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">(x) dx = G<sub>m,jk</sub>(y) &nbsp;, where m&gt;0.&nbsp;</span></div></div><div><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\"><br></span></div><div><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">Such integrals arise in calculations of pairwise fermion interactions in condensed matter systems, e.g., when calculating the electron EM exchange energy (see, e.g., the 'specfunc.ElectronDegPres' example and&nbsp;</span><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">§ 80 in Landau and Lifshitz, Statistical Physics Part 1 (3rd edition), 1980</span><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\">).</span></div><div><span style=\"font-family: 'DejaVu Sans Mono'; font-size: 12px;\"><br></span></div><div><font face=\"DejaVu Sans Mono\">The values of y and m can be adjusted via the integrand parameters during model runtime. The values of j and k, however, must be chosen before creating (compiling) the integrand (see 'DoubleFDIntegrand').</font></div><div><font face=\"DejaVu Sans Mono\"><br></font></div><div><font face=\"DejaVu Sans Mono\">Note that here -y<sub>max</sub>&nbsp;is chosen instead of -∞ since for most such integrals, very little contribution arises from the x&lt;&lt;-1 region.</font></div><div><font face=\"DejaVu Sans Mono\"><br></font></div><div><font face=\"DejaVu Sans Mono\">For values of m&lt;1, care must be taken with the choice of integration routine as a singularity at x=y will appear in the integrand.</font></div><div><font face=\"DejaVu Sans Mono\"><br></font></div><img src=\"modelica://GNU_ScientificLibrary/Examples/integration/Gmjk_vs_y.png\"></body></html>"),
