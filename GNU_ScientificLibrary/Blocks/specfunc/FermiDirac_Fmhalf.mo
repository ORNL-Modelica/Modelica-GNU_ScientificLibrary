...
block FermiDirac_Fmhalf
  extends Blocks.BaseClasses.Partial_F_l_Block(final l = 0);
equation
  y = Functions.specfunc.fermidirac_Fmhalf(x);
  annotation(
    Icon(graphics = {Text(extent = {{-78, 18}, {70, -12}}, lineColor = {0, 0, 0}, textString = "F_1/2(x)")}),
